namespace MvcMusicStore.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        ShoppingCartViewModel_RecordID = c.Int(),
                    })
                .PrimaryKey(t => t.RecordId)
                .ForeignKey("dbo.Albums", t => t.AlbumId, cascadeDelete: true)
                .ForeignKey("dbo.ShoppingCartViewModels", t => t.ShoppingCartViewModel_RecordID)
                .Index(t => t.AlbumId)
                .Index(t => t.ShoppingCartViewModel_RecordID);
        ...
        {
            DropForeignKey("dbo.Carts", "ShoppingCartViewModel_RecordID", "dbo.ShoppingCartViewModels");
            ...
            DropIndex("dbo.Carts", new[] { "ShoppingCartViewModel_RecordID" });
